...
def is_element_in(element) :
    if element in container :
        return True


print(is_element_in(element, container))
print(function_performance(is_element_in, element, setContainer , how_many_times))         # szybszy niż lista
